...
(function (global, factory) {
  ...
  function (
    ...
    const TemplateFactory__default =
      /*#__PURE__*/ _interopDefaultLegacy(TemplateFactory);
    ...
    class Tooltip extends BaseComponent__default.default {
      ...
      _getConfig(config) {
        const dataAttributes = Manipulator__default.default.getDataAttributes(
          this._element
        );
      ...
      _configAfterMerge(config) {
        config.container =
          config.container === false
            ? document.body
            : index.getElement(config.container);
