...
2. Review the [Jasmine API Documentation](https://jasmine.github.io/pages/docs_home.php) and use the existing tests as references for how to structure your new tests.
...
- Each test should use [`expect`](https://jasmine.github.io/api/edge/matchers.php) to ensure something is expected.
