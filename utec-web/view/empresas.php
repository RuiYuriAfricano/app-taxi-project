                        ...
                        <div class="align-items-strech">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade" id="nav-new" role="tabpanel" aria-labelledby="nav-new-tab" tabindex="0">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title fw-semibold mb-4">Nova empresa</h5>
                                            <div class="card">
                                                <div class="card-body">
                                ...
                                <div class="tab-pane fade show active" id="nav-list" role="tabpanel" aria-labelledby="nav-list-tab" tabindex="0">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title fw-semibold mb-4">Lista de empresas</h5>
                                                    ...
                                                    <div class="card-body p-4">
                                                        <div class="table-responsive">
                                                            <table class="table text-nowrap mb-0 align-middle">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    include_once '../services/EmpresaService.php';

                                                                    $service = new EmpresaService();
                                                                    $service->viewTabelaEmpresa();
                                                                    ?>
                                                                </tbody>
                                                            </table>
                                                        </div>
