                        ...
                        <div class="align-items-strech">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade" id="nav-new" role="tabpanel" aria-labelledby="nav-new-tab" tabindex="0">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title fw-semibold mb-4">Novo motorista</h5>
                                            <div class="card">
                                                <div class="card-body">
                                                    <form action="../controllers/actionMotorista.php" method="post">
                                                        <input type="hidden" name="cadastrar" value="true">
                                                        <div class="mb-3">
                                                            <label for="nome" class="form-label">Email</label>
                                                            <input type="email" name="email" class="form-control" id="email" aria-describedby="nomeHelp">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="apelidos" class="form-label">Morada</label>
                                                            <input type="text" name="morada" class="form-control" id="morada" aria-describedby="apelidosHelp">
                                                        </div>
                                                        <div class="mb-3">
                                ...
                                <div class="tab-pane fade show active" id="nav-list" role="tabpanel" aria-labelledby="nav-list-tab" tabindex="0">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title fw-semibold mb-4">Lista de motoristas</h5>
                                                    ...
                                                    <div class="card-body p-4">
                                                        <div class="table-responsive">
                                                            <table class="table text-nowrap mb-0 align-middle">
                                                                ...
                                                                <tbody>
<?php
include_once '../services/MotoristaService.php';

$service = new MotoristaService();
$service->viewTabelaMotorista();
?>
