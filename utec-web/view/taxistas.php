                        ...
                        <div class="align-items-strech">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-link active" href="taxistas.php">Taxistas</a>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-consulta1" role="tabpanel" aria-labelledby="nav-consulta1-tab" tabindex="0">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title fw-semibold mb-4">5 Taxistas com mais desvios de facturamento</h5>
                                                            ...
                                                            <table class="table text-nowrap mb-0 align-middle">
                                                                <thead class="text-dark fs-4">
                                                                    <tr>
                                                                        ...
                                                                        <th class="border-bottom-0">
                                                                            <h6 class="fw-semibold mb-0">Valor total facturado</h6>
                                                                        </th>
                                                                        <th class="border-bottom-0">
                                                                            <h6 class="fw-semibold mb-0">Valor total previsto</h6>
                                                                        </th>
                                                                        <th class="border-bottom-0">
                                                                            <h6 class="fw-semibold mb-0">Diferenca</h6>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
