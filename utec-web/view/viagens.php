        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./empresas.php" aria-expanded="false">
                <span>
                ...
                <span class="hide-menu">Empresas de taxi</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="./taxis.php" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./index.php" aria-expanded="false">
                ...
                <span class="hide-menu">Consultas Rápidas</span>
              </a>
            </li>
          </ul>
          ...
          <div class="align-items-strech">
            ...
            <div class="tab-content" id="nav-tabContent">
              <div class="tab-pane fade show active" id="nav-consulta1" role="tabpanel" aria-labelledby="nav-consulta1-tab" tabindex="0">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Últimas 10 viagens realizadas</h5>
                              ...
                              <thead class="text-dark fs-4">
                                <tr>
                                  <th class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">N* da viagem</h6>
                                  </th>
                                  <th class="border-bottom-0">
                                  ...
                                  <th class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0"> Data da viagem</h6>
                                  </th>
                                </tr>
                              </thead>
                              <tbody>
              ...
              <div class="tab-pane fade" id="nav-consulta2" role="tabpanel" aria-labelledby="nav-consulta2-tab" tabindex="0">
                <div class="card">
                  <div class="card-body">
              ...
              <div class="tab-pane fade" id="nav-consulta3" role="tabpanel" aria-labelledby="nav-consulta3-tab" tabindex="0">
                
              </div>
              <div class="tab-pane fade" id="nav-consulta4" role="tabpanel" aria-labelledby="nav-consulta4-tab" tabindex="0">
                
              </div>
              <div class="tab-pane fade" id="nav-consulta5" role="tabpanel" aria-labelledby="nav-consulta5-tab" tabindex="0">
                
              </div>
              <div class="tab-pane fade" id="nav-consulta6" role="tabpanel" aria-labelledby="nav-consulta6-tab" tabindex="0">
           
              </div>
              <div class="tab-pane fade" id="nav-consulta7" role="tabpanel" aria-labelledby="nav-consulta7-tab" tabindex="0">
   
              </div>
              <div class="tab-pane fade" id="nav-consulta8" role="tabpanel" aria-labelledby="nav-consulta8-tab" tabindex="0">
